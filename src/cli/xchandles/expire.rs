...
use crate::{
    ...
    yes_no_prompt, CliError, Db, DefaultCatMakerArgs, SageClient, Slot,
    XchandlesExponentialPremiumRenewPuzzleArgs, XchandlesExtendAction, XchandlesSlotValue,
};
...
pub async fn xchandles_expire(
    ...
    let payment_cat_amount = XchandlesExponentialPremiumRenewPuzzleArgs::from_scale_factor(
        &mut ctx,
        payment_cat_base_price,
        1000,
    )?
    ...
    yes_no_prompt("Continue with expiration (re-registration)?")?;
