...
async fn lookup_handle_proof(
    ...
    Ok(HandleProofResponse {
        ...
        slot_parent_id: hex32(slot.parent_coin_id),
        slot_parent_parent_id: hex32(slot.parent_parent_id),
        slot_parent_inner_puzzle_hash: hex32(slot.parent_inner_puzzle_hash),
