...
pub struct StateSchedulerLayer<S> {
...
impl<S> Layer for StateSchedulerLayer<S>
where
    S: ToClvm<Allocator> + FromClvm<Allocator> + Copy,
{
    ...
    fn parse_puzzle(allocator: &Allocator, puzzle: Puzzle) -> Result<Option<Self>, DriverError> {
        ...
        let args = StateSchedulerLayerArgs::<NodePtr, S>::from_clvm(allocator, puzzle.args)?;
...
pub const STATE_SCHEDULER_PUZZLE: [u8; 393] = hex!("");

pub const STATE_SCHEDULER_PUZZLE_HASH: TreeHash = TreeHash::new(hex!(
    "
    58342418fe87bb90f1c6c5f18cd17850444f413441468be77ba60be4400b0b83
    "
));

#[derive(FromClvm, ToClvm, Debug, Clone, PartialEq, Eq)]
#[clvm(curry)]
pub struct StateSchedulerLayerArgs<T, S> {
    pub other_singleton_struct: SingletonStruct,
    pub base_conditions: T,
    pub new_state: S,
}

impl<T, S> StateSchedulerLayerArgs<T, S>
where
    T: ToTreeHash,
    S: ToTreeHash,
{
